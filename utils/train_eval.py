    ...
    for epoch in range(config.num_epochs):
        ...
        for i, (input_ids, labels_ids) in enumerate(train_iter):
            ...
            if total_batch % config.batch_to_out == 0:
                ...
                print(type(cur_true_label))#train_f1 = f1_score(cur_true_label, cur_predict_label, average='macro')
                print(len(cur_true_label))#train_f1 = f1_score(cur_true_label, cur_predict_label, average='macro')
                print(type(cur_predict_label))#train_f1 = f1_score(cur_true_label, cur_predict_label, average='macro')
                print(len(cur_predict_label))#train_f1 = f1_score(cur_true_label, cur_predict_label, average='macro')
